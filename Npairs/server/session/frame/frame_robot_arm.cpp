#include "frame_robot_arm.hpp"

namespace Frame
{

    FrameRobotArm::FrameRobotArm(boost::asio::streambuf &streambuf)
    : streambuf_(streambuf)
    {
    }


    bool FrameRobotArm::trimToLeadingChars() 
    {
    ...
    size_t FrameRobotArm::parseFrameSize() const 
    {
        int matchStatus = -1;
        size_t startPosition = -1;
        auto d = boost::asio::buffers_begin(streambuf_.data());
    ...
    void FrameRobotArm::print(size_t frameSize, std::ostream &out) const
    {
        auto d = boost::asio::buffers_begin(streambuf_.data());
    ...
    void FrameRobotArm::writeFrameContent(unsigned char *pStart, size_t dataSize) 
    {
